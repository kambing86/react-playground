...
import { customFetcher } from '@/data/starwars/fetcher';
...
export type AllFilmsQuery = { __typename?: 'Root', allFilms?: { __typename?: 'FilmsConnection', films?: Array<{ __typename?: 'Film', title?: string | null } | null> | null } | null };
...
export const useAllFilmsQuery = <
    ...
    >(
      ...
      options?: Omit<UseQueryOptions<AllFilmsQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<AllFilmsQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<AllFilmsQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['allFilms'] : ['allFilms', variables],
    queryFn: customFetcher<AllFilmsQuery, AllFilmsQueryVariables>(AllFilmsDocument, variables),
    ...options
  }
    )};

useAllFilmsQuery.getKey = (variables?: AllFilmsQueryVariables) => variables === undefined ? ['allFilms'] : ['allFilms', variables];

useAllFilmsQuery.rootKey = 'allFilms';

export const useSuspenseAllFilmsQuery = <
      TData = AllFilmsQuery,
      TError = unknown
    >(
      variables?: AllFilmsQueryVariables,
      options?: Omit<UseSuspenseQueryOptions<AllFilmsQuery, TError, TData>, 'queryKey'> & { queryKey?: UseSuspenseQueryOptions<AllFilmsQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useSuspenseQuery<AllFilmsQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['allFilmsSuspense'] : ['allFilmsSuspense', variables],
    queryFn: customFetcher<AllFilmsQuery, AllFilmsQueryVariables>(AllFilmsDocument, variables),
    ...options
  }
    )};

useSuspenseAllFilmsQuery.getKey = (variables?: AllFilmsQueryVariables) => variables === undefined ? ['allFilmsSuspense'] : ['allFilmsSuspense', variables];

useSuspenseAllFilmsQuery.rootKey = 'allFilms';


useAllFilmsQuery.fetcher = (variables?: AllFilmsQueryVariables, options?: RequestInit['headers']) => customFetcher<AllFilmsQuery, AllFilmsQueryVariables>(AllFilmsDocument, variables, options);
